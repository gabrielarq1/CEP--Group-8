...
For Round 1, our group decided to follow a sequential workflow so that only one person worked on the shared report at a time. Yushan began by creating the report structure and completing Prompts 1 and 2. Veronica then added Prompts 7 and 8. Before I started working on Prompts 3 and 4, I confirmed with the group that the newest version had been pushed and pulled it from GitHub. After I completed and pushed my section, Gabriela worked on Prompts 5 and 6, followed by Alondra, who completed Prompts 9 and 10. Each member confirmed that the latest version was available before beginning their assigned section.
...
|------------------|------------------|------------------|------------------|
| Yushan Huang | SashaHuang1 | Create collaboration practice report and add Yushan's responses to Prompts 1 and 2 | Improve Prompt 3 workflow explanation and update collaboration evidence |
| Simran Kaur | Simrank-DM | Add Simran's responses for Prompts 3 and 4 | Improve Prompt 2 with Git workflow graphics |
| Gabriela Raygoza Quintero | gabrielarq1 | Update Group 8 week 3 collaborative practice | revise repository sections |
| Veronica Vega | vvega8893 | Add Veronica's responses for Prompts 7 and 8. | Add access token security guidance to Prompt 9 |
| Alondra Rodriguez | aodriguezz240 | Add Alondra's responses to prompts 9 and 10 | Cosmetic changes from Alondra to section 5 |

## Required Links

-   **Group GitHub repository:** <https://github.com/gabrielarq1/CEP--Group-8>
-   **Repository commit history:** <https://github.com/gabrielarq1/CEP--Group-8/commits/main>
